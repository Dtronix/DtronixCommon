...
public class QuadTreeBenchmarks
{
    ...
    private DoubleQuadTree2<Item> _quadTreeD2;
    private FloatQuadTree<Item> _quadTreeFFull;
    private DoubleQuadTree<Item> _quadTreeDFull;
    private DoubleQuadTree2<Item> _quadTreeD2Full;
    ...
    public void GlobalSetup()
    {
        ...
        _quadTreeD2 = new DoubleQuadTree2<Item>(10000, 10000, 8, 8, 200);
        ...
        _quadTreeD2Full = new DoubleQuadTree2<Item>(10000, 10000, 8, 8, 1024);
        for (int x = 0; x < 50; x++)
        {
            for (int y = 0; y < 50; y++)
            {
